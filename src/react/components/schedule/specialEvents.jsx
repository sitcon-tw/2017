		...
		<div>
			...
			<section>
				...
				<ol>
					...
					<li>與年會中各攤位交流亦有機會獲得額外程式碼拼圖，同一攤位限領一張額外片段</li>
					<li>每段程式碼不可重複使用</li>
			...
			<section>
				...
				<ol>
					...
					<li>活動不僅限於面對面進行，參與者亦可用任何方式尋找夥伴。</li>
				</ol>
			</section>
		</div>
	)
	...
	return (
		<div>
			<section>
				...
				<p>Lightning talk，中文譯為「閃電秀」，顧名思義即為「閃電一般短的演講」。包含準備時間在內，每位講者僅有 3 分鐘的時間上台。用飛快的速度進行簡潔扼要的分享，無論是對台上的講者或是台下的會眾，都是十分刺激又轟動全場的體驗。Lightning talk 將會在年會當天早上 10:00 於白板區開放報名，先搶先贏，並在所有議程結束後，閉幕前，在國際會議廳進行演講。</p>
			</section>
		</div>
	)
}
